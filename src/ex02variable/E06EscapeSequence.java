...
//		같은 출력문장이지만 println()을 사용하면 아래와 같이 문자열과 변수를 분리해서 
//		기술해야 하므로 조금 더 복잡하다.
		System.out.println("\n국어 : "+kor+", 영어 : "+ eng+", 수학 : "+math);
		
//		실수는 %f를 사용.
//		또한 정수와 실수의 연산이므로 결과는 실수가 반환되어 double타입으로 선언한 변수에 대입한다.
		double avg = (kor+eng+math) / 3.0;
		System.out.printf("평균점수 : %f%n", avg);
		
/*
자리수 지정하기 
 %4d : 정수출력 시 전체자리수를 4자리로 표현
 %6.2f : 실수 출력 시 전체 자리수는 6자리, 소수이하 2자리로 표현
