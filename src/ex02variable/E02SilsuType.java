...
/*
 ...
 - 소수점이 있는 데이터를 float에 대입하려면 접미사(F 혹은 f)를 붙여야함
*/
		float f3 = 100;
		
//		에러발생. 3.14자체를 double로 인식
//		float f4 = 3.14;
		
//		강제 형변환 후 대입할 수 있으나 권장하지 않음
		float f4 = (float)3.14;
