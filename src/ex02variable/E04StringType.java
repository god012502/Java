...
/*
String클래스
 참조형 변수로써 기본자료형이 아닌 클래스로 문자열을 저장하고,
 조작하는 하는 기능을 가지고 있다.
 Java에서는 문자열을 표현할 때 "(Double quotation)으로 감싸주면 되고 
 연결시에는 +기호를 사용한다.
*/
		int number;
		number = 99;
...
/*
문자열 + 정수
 우선순위가 없다면 문자열과 숫자가 연결된 상태로 출력된다.
 단 산술연산의 결과를 출력하고 싶다면 아래와 같이 소괄호로 묶어 
 우선순위에 대한 변화를 주면 된다	
*/
		int kor=100, eng=99, math=98;
//		단순히 문자 연결된 형태로 출력됨 100+99+98 = 1009988
		System.out.println("총점: "+kor+eng+math);
//		덧셈 연산의 결과로 (100+99+98) 297출력
		System.out.println("총점: "+(kor+eng+math));
	}
}
